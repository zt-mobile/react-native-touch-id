...
public class FingerprintDialog extends DialogFragment implements FingerprintHandler.Callback {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        getDialog().setTitle(Html.fromHtml("<font color='#FFFFFF'>"+this.dialogTitle+"</font>"));
        this.mFingerprintSensorDescription.setTextColor(Color.parseColor("#FFFFFF"));
        mFingerprintDescription.setTextColor(Color.parseColor("#FFFFFF"));
        mCancelButton.setTextColor(Color.parseColor("#FFFFFF"));
